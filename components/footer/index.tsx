...
export const Footer = () => {
  return (
    <footer className="dark:bg-gray-800 dark:border-gray-700 bg-blue-500">
      <div className="mx-auto max-w-7xl py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center order-2" aria-label="Footer">
          <div className="px-5">
            <Link href="/terms" className="text-base text-white hover:text-gray-200">
              Terms of Service
            </Link>
          </div>

          <div className="px-5">
            <Link href="/privacy" className="text-base text-white hover:text-gray-200">
              Privacy Policy
            </Link>
          </div>
        </nav>
